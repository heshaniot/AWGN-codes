function ldpc120_R13(ebn) 
%  LDPC_heshani_504b_R23
  % == LDPC SETTINGS ====================================
  RunID=0;
  TxRx.Sim.name = 'LDPC_heshani_120b_R13';
...
%   snr =1;
  ...
  load('codes/LDPC_heshani_120b_R13.mat'); % load code
  
  % == EXECUTE SIMULATION ===============================  
  label.folder = 'FADING_RESULTS/N128';
  label.number = no;
  label.rate = 13 ;
  sim_LDPC_QAM_AWGN_lowRates(RunID,TxRx,LDPC,label) 
